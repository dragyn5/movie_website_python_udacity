...
# This is where new movies are added to the website
...
# Movies array is created and movies are added
movies = [fight_club ,the_matrix, groundhog_day, hercules]

# This method opens the website feeding in the movies array
